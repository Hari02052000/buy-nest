...
exports.invoiceUtils = exports.InvoiceUtils = void 0;
const pdfkit_1 = __importDefault(require("pdfkit"));
class InvoiceUtils {
    /**
     * Generate PDF invoice from order data
     */
    static generateInvoicePDF(order) {
    ...
    static addInvoiceDetails(doc, order) {
        const startY = 220;
        doc
            .fontSize(10)
     ...
     */
    static generateInvoiceFilename(order) {
