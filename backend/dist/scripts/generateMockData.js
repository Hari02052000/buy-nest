...
const product_model_1 = __importDefault(require("../infrastructure/model/product.model"));
const category_model_1 = __importDefault(require("../infrastructure/model/category.model"));
...
function generateRandomProduct(categoryId, categoryName) {
    ...
    const randomType = productTypes[categoryName][Math.floor(Math.random() * productTypes[categoryName].length)];
...
function generateMockData() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            // Connect to database
            yield mongoose_1.default.connect(environment_1.env.DB_URL);
            ...
            const createdCategories = yield category_model_1.default.insertMany(categoriesData);
            ...
            for (const category of createdCategories) {
                ...
                for (let i = 0; i < additionalCount; i++) {
                    allProducts.push(generateRandomProduct(category._id.toString(), category.name));
                }
            }
            // Create products
            console.log("Creating products...");
            const createdProducts = yield product_model_1.default.insertMany(allProducts);
